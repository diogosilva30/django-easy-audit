...
class CRUDEvent(models.Model):
    ...
    object_id = models.CharField(
        max_length=255, verbose_name=_("Object ID"), db_index=True
    )
    ...
    object_repr = models.TextField(
        null=True, blank=True, verbose_name=_("Object representation")
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["object_id", "object_repr"]),
...
class LoginEvent(models.Model):
    ...
    remote_ip = models.CharField(
        max_length=50, null=True, db_index=True, verbose_name=_("Remote IP")
    )
    datetime = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_("Date time"),
